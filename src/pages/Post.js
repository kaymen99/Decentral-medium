    ...
    async function giveAtip() {
        if (data.network === networksMap[networkDeployedTo]) {
            ...
            try {
                ...
                const tip_tx = await medium.tipPostCreator(
                    Number(id),
                        ...
                        <div className="mainheading">
                            ...
                            <div className="row post-top-meta">
                                <div className="col-md-2">
                                    <a href={"/author-dashboard/" + post.authorAddress}><img className="author-thumb" src={post.authorImg} alt="Sal" /></a>
                                </div>
                                            ...
                                            <Modal show={show} onHide={handleClose}>
                                                ...
                                                <Modal.Footer>
                                                    ...
                                                    <Button variant="primary"
                                                        type='submit'
                                                        onClick={() => { giveAtip() }}>
                                                        {loading ? <CircularProgress color="inherit" /> : "Go"}
                                                    </Button>
                                                </Modal.Footer>
                                            </Modal>
                                        </>
                                            ...
                                            <div className="metafooter">
                                                <div className="wrapfooter">
                                                    <span className="meta-footer-thumb">
                                                        <a href={"/author-dashboard/" + post.authorAddress}><img className="author-thumb" src={post.authorProfileImg} alt="Sal" /></a>
                                                    </span>
